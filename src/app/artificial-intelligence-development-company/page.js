  ...
  return (
    <div>
        ...
        <div class="container container-fluid">
            <section>
                <div class="row firstsec d-flex align-items-center py-4">
                    <div class="col-lg-6 col-sm-12 mb-5 mb-lg-0">
                        <h1 class="all-head">Artificial Intelligence Development Company </h1>
                        <p class="all-p me-5 mb-4 mt-3">We build automation tools and software for businesses to get
   ...
   <ClientSlider />
    ...
    <div class="container container-fluid">
        <section>
            <div class=" d-flex align-items-center flex-column justify-content-center firstsec mb-5">
                <h1 class="all-head">Our Services </h1>
                <p class="all-p text-center">We offer various Artificial Intelligence development services for multiple
                    business sectors.
                </p>
            </div>
            <div class="row ">
                <div class="col-xl-4 col-md-6 col-sm-12 pb-3 ">
                    <div class="service-block p-4 h-100">
                        ...
                        <h2 class="secondsec-head mt-4">LLM AI Consultation</h2>
                        <p class="secondsec-p">Our LLM Artificial Intelligence Consultation service is your one-stop
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 pb-3 ">
                    <div class="service-block p-4 h-100">
                        ...
                        <h2 class="secondsec-head mt-4">Generative AI Development</h2>
                        <p class="secondsec-p">Codiste offers enterprise-grade Generative Artificial Intelligence
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 pb-3 ">
                    <div class="service-block p-4 h-100">
                        ...
                        <h2 class="secondsec-head mt-4">Language Processing</h2>
                        <p class="secondsec-p">We offer Artificial Intelligence Language Processing service utilizing
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 pb-3 ">
                    <div class="service-block p-4 h-100">
                        ...
                        <h2 class="secondsec-head mt-4">Deep Learning Tools</h2>
                        <p class="secondsec-p">Our Deep Learning Tools service offers development support with the
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 pb-3 ">
                    <div class="service-block p-4 h-100">
                        ...
                        <h2 class="secondsec-head mt-4">Visual Analysis</h2>
                        <p class="secondsec-p">Codiste has an expert-led Visual Analysis development team that leverages
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 pb-3 ">
                    <div class="service-block p-4 h-100">
                        ...
                        <h2 class="secondsec-head mt-4">Predictive Modeling</h2>
                        <p class="secondsec-p">Our Predictive Modeling service caters to businesses and enterprises with
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 pb-3 ">
                    <div class="service-block p-4 h-100">
                        ...
                        <h2 class="secondsec-head mt-4">Stable Diffusion</h2>
                        <p class="secondsec-p">We offer a Stable Diffusion development service to help businesses
    ...
    <div class="py-5">
        <div class="container container-fluid">
            <div class=" d-flex align-items-center flex-column justify-content-center mb-5">
                <h1 class="all-head">Why Choose Us For Artificial Intelligence Development Services?</h1>
                <p class="all-p text-center">Codiste is a rapidly growing Artificial Intelligence development service
            ...
            <div class="row">
                <div class="col-6 col-md-4 text-center p-5 intsec-border">
                    <img class="img-fluid mb-2" alt="A multitude of AI Technologies" src="assets/images/ai.png" />
                    <h2 class="secondsec-head text-center">A multitude of AI Technologies </h2>
                    <p class="secondsec-p text-center">Experts lead our team at Codiste with extensive knowledge and experience in
                ...
                <div class="col-6 col-md-4 text-center p-5 intsec-border">
                    <img class="img-fluid mb-2" alt="Custom AI Solutions" src="assets/images/replacement.png" />
                    <h2 class="secondsec-head text-center">Custom AI Solutions</h2>
                    <p class="secondsec-p text-center">At Codiste, we offer customized Artificial Intelligence development services
                ...
                <div class="col-6 col-md-4 text-center p-5 intsec-borderlast">
                    <img class="img-fluid mb-2" alt="Efficient & Optimized Development" src="assets/images/air.png" />
                    <h2 class="secondsec-head text-center">Efficient & Optimized Development </h2>
                    <p class="secondsec-p text-center">Our agile development process ensures fast and efficient development of
                ...
                <div class="col-6 col-md-4 text-center p-5 intsec-borderbelow">
                    <img class="img-fluid mb-2" alt="Advanced Analytics Capabilities" src="assets/images/increasing.png" />
                    <h2 class="secondsec-head text-center">Advanced Analytics Capabilities</h2>
                    <p class="secondsec-p text-center">Our Artificial Intelligence development team leverages advanced analytics
                ...
                <div class="col-6 col-md-4 text-center p-5 intsec-borderbelow">
                    <img class="img-fluid mb-2" alt="Data Security and Privacy" src="assets/images/cloud.png" />
                    <h2 class="secondsec-head text-center">Data Security and Privacy</h2>
                    <p class="secondsec-p text-center">We give utmost importance and attention to data security and privacy while
                ...
                <div class="col-6 col-md-4 text-center p-5 ">
                    <img class="img-fluid mb-2" alt="Post Sales Assistance" src="assets/images/support.png" />
                    <h2 class="secondsec-head text-center">Post Sales Assistance </h2>
                    <p class="secondsec-p text-center">Codiste provides continuous customer support and maintenance for our
        ...
        <div class="container container-fluid">
            <section>
                <div class=" d-flex align-items-center flex-column justify-content-center">
                    <h1 class="all-head">Technologies We Offer </h1>
                    <p class="all-p me-5 text-center">We offer you to choose from a wide range of technologies. 
            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                        ...
                        <div class="accordion-body">AI is a broad field with multiple supporting technologies like
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">While AI has the potential to automate many tasks and augment human
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">AI models are trained using large amounts of data, which is used to
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapsefour" class="accordion-collapse collapse" aria-labelledby="flush-headingfour"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">The future of AI is expected to bring about significant advancements
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapsefive" class="accordion-collapse collapse" aria-labelledby="flush-headingfive"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">Conversational AI can be used by businesses to automate customer
    ...
    <div class="container container-fluid py-5">
        <div class=" d-flex align-items-center flex-column justify-content-center mb-5">
            ...
            <p class="all-p text-center">Read more about artificial intelligence and modern technological developments
    ...
    <div class="bg-color py-5">
        <div class="container container-fluid">
          <section>
            <div class=" d-flex align-items-center flex-column justify-content-center mb-5">
              <h1 class="all-head">Client feedback speaks volumes. See for yourself!</h1>
        ...
        <section>
            <div class="row  d-flex align-items-center">
                <div class="col-lg-6 col-md-12 mb-5 mb-lg-0 needsec">
                    ...
                    <h2 class=""> Reach out to us with your problems, our team will get in touch with you soon.
                    </h2>
