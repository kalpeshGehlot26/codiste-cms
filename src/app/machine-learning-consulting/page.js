    ...
    <div>
        ...
        <div className="container container-fluid">
          ...
          <div className='row g-4'>
            <div className='col-xl-4 col-md-6 col-sm-12'>
              <div className='newservice-box'>
                <h3>End-to-End Development Support</h3>
                <p>We ensures a smooth and seamless development process and timely delivery of your metaverse experience, making it easier for your enterprise to integrate metaverse.</p>
              </div>
            </div>
            <div className='col-xl-4 col-md-6 col-sm-12'>
              <div className='newservice-box'>
      ...
      <div className="py-5 bg-color mt-5">
        <div className="container container-fluid">
          <div className=" d-flex align-items-center flex-column justify-content-center mb-5">
            <h1 className="all-head text-center">
              Industries We Serve as a leading ML Development Company
            </h1>
          </div>
        </div>
      </div>
