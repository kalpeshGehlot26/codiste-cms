						...
						<div className="row firstsec ">
							<div className="col-12 col-md-8 col-lg-10 d-flex mx-auto flex-wrap my100 align-items-center justify-content-between">
								<div className="col-12 col-lg-5 order-2 order-lg-1 p-4">
									...
									<p className="all-p me-5 my-4">We offer machine learning development services for businesses & enterprises to help them automate repetitive and recursive tasks. Our machine learning development team helps you leverage the power of machine learning to boost your organizational growth and efficiency.
									</p>
