              ...
              <ol class="ps-timeline">
                <li>
                  <div class="img-handler-top">
                    <h4 className="text-center">Scope and Defining the predictive analytics model</h4>
                ...
                <li>
                  <div class="img-handler-top">
                    <h4 className="text-center">Data Cleansing & Integration</h4>
                ...
                <li>
                  <div class="img-handler-bot">
                    ...
                    <p>The final step where the model gets monitored after the deployment in a live environment and measured for its effectiveness, if needed correcting actions will be done.</p>
                  </div>
                  <div class="ps-top">
                    {/* <img src="http://www.physology.co.uk/wp-content/uploads/2016/02/ps-elem_13.png" alt="" /> */}
                  </div>
