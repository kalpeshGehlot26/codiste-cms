      ...
      <div className="container container-fluid">
        <div className="row">
          ...
          <div className="col-lg-6 col-12 mb-5 order-1 order-lg-2 text-center">
            <img className='img-fluid' style={{padding: "20px"}} src="/assets/images/diwallet-case/Case Study.png" alt="Diwallet-Case"/>
        </div>
        </div>
      </div>
    </div>
                ...
                <ul className="diwallet-style">
                    <li  className="">
                        <img className='img-fluid' alt='Tamper -proof' src="/assets/images/case-couter10/Tamper -proof.png" />
                          <p><span className="fs-3">Tamper -proof </span><br />CounterTEN is built on the Solana blockchain, providing tamper-proof and easily verifiable digital assets. 
                          </p>
                    </li>
                    <li >
                        <img className='img-fluid' alt='Purpose Flexibility' src="/assets/images/case-couter10/Purpose Flexibility.png" />
                          <p><span className="fs-3">Purpose Flexibility</span><br />Brands can create NFTs for a wide range of purposes, including event access, specialized VIP perks, product launches, memberships, property rentals, collectibles, and more. 
                          </p>
                         
                    </li>
                    <li>
                        <img className='img-fluid' alt='Revenue' src="/assets/images/case-couter10/Revenue and Engagement.png" />
                        <p><span className="fs-3">Revenue and Engagement</span><br /> CounterTEN offers flexibility to businesses looking to increase revenue, engagement, or both.
                        </p>
          ...
          <section>
            <div className=" d-flex align-items-center flex-column justify-content-center mb-5">
             <h1 className="all-head text-center">Satisfied clients is our proof of our excellence</h1>
              <p className="all-p text-center">Their Success Stories are our Valuable Feedback</p>
            </div>
