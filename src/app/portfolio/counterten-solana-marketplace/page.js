					...
					<div className="row">
						<div className="col-xl-6 col-sm-12 mb-5  d-flex  justify-content-center flex-column">
							<p className="secondsec-p">
								{" "}
								CounterTEN was developed by Codiste, A
								blockchain application development company Where
								Blockchain and NFT development team to create a
								mainstream NFT platform that enables brands to
								engage with customers beyond what is currently
								available in the NFT marketplace. The platform
								aims to provide tools and a flexible platform
								for brands to create and sell NFTs for revenue,
								engagement, or both.
							</p>
						</div>
				...
				<div className="container container-fluid">
					<div className="row">
						<div className="col-xl-6 col-sm-12 mb-5  d-flex  justify-content-center flex-column">
							<p className="secondsec-p">
								{" "}
								The NFT market is rapidly expanding, and brands
								need a reliable platform to create, sell, and
								manage NFTs. Additionally, there is a need for a
								platform that provides flexibility to businesses
								looking to monetize their work and engage with
								their customers beyond traditional marketing
								channels.
							</p>
						</div>
						<div className="col-xl-6 col-sm-12 mb-5">
								...
								<ul className="diwallet-style">
									<li className="">
										<img
											className="img-fluid"
											alt=""
											src="/assets/images/case-couter10/Tamper -proof.png"
										/>
										<p>
											<span className="fs-3">
												Tamper -proof{" "}
											...
											<br />
											CounterTEN is built on the Solana
											blockchain, providing tamper-proof
											and easily verifiable digital
											assets.
										</p>
									</li>
									<li>
										<img
											className="img-fluid"
											alt=""
											src="/assets/images/case-couter10/Purpose Flexibility.png"
										/>
										<p>
											<span className="fs-3">
												Purpose Flexibility
											...
											<br />
											Brands can create NFTs for a wide
											range of purposes, including event
											access, specialized VIP perks,
											product launches, memberships,
											property rentals, collectibles, and
											more.
										</p>
									</li>
									<li>
										<img
											className="img-fluid"
											alt=""
											src="/assets/images/case-couter10/Revenue and Engagement.png"
										/>
										<p>
											<span className="fs-3">
												Revenue and Engagement
											</span>
											<br /> CounterTEN offers flexibility
											to businesses looking to increase
											revenue, engagement, or both.
										</p>
									</li>
								</ul>
							</div>
