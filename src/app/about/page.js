...
const About = () => {
	return (
		<div>
			<div class="container container-fluid py-5 firstsec">
			...
			<div class="firstsec bg-color">
				<div class="container container-fluid">
					<div class="row ">
						<div class="col-xl-6 col-sm-12 mb-5 d-flex justify-content-center flex-column">
							<h1 class="all-head ">MISSION</h1>
							<p class="secondsec-p ">
						...
						<div class="col-xl-6 col-sm-12 mb-5 aboutall-p d-flex  justify-content-center flex-column">
							<h1 class="all-head">VISION</h1>
							<p class="secondsec-p ">
			...
			<div class="container container-fluid  py-5">
				<section>
					<div class=" d-flex align-items-center flex-column justify-content-center mb-5">
						<h1 class="all-head">Our Values</h1>
						...
						<div class="col-lg-12">
							<ul class="About-style">
								<li>
									...
									/>
									<p class="secondsec-p">Collaboration</p>
								</li>
								<li>
									<img
										class="img-fluid"
								...
								<li>
									...
									/>
									<p class="secondsec-p">Customer Focus</p>
								</li>
								<li>
									<img
										class="img-fluid"
								...
								<li>
									...
									/>
									<p class="secondsec-p">Excellence</p>
								</li>
								<li>
									<img
										class="img-fluid"
									...
									/>
									<p class="secondsec-p">Innovation</p>
								</li>
								<li>
									<img
										class="img-fluid"
								...
								<li>
									...
									/>
									<p class="secondsec-p">Integrity</p>
								</li>
								<li>
									<img
										class="img-fluid"
									...
									/>
									<p class="secondsec-p">Accountability</p>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="bg-color firstsec">
				<div class="container container-fluid py-4">
					<h1 class="all-head text-center mb-5">Leadership Team</h1>
					<div class="row">
						<div class="col-auto mb-5">
							<img
								class="img-fluid leader"
								src="assets/images/about/Nishant.png"
								alt=""
							/>
						</div>
						<div class="col mb-5 aboutall-p">
							<div>
								<div class="d-flex">
									<h1 class="me-4 aboutall-h">
										Nishant Bijani
									</h1>
									<img
								...
								<p class="aboutall-p"> Co-Founder & CTO</p>
							</div>
							<div class="secondsec-p">
								<p>
					...
					<div class="row">
						...
						<div class="col  aboutall-p">
							<div>
								<div class="d-flex">
									<h1 class="me-4 aboutall-h">Nic Roux</h1>
									<img
										class="img-fluid mb-4"
										src="assets/images/about/linkedin.png"
										alt=""
								...
								<p class="aboutall-p">Co-Founder</p>
							</div>
							<div class="secondsec-p">
								<p>
			...
			<div class="container container-fluid  py-5">
				<section>
					<div class=" d-flex align-items-center flex-column justify-content-center mb-5">
						<h1 class="all-head">Services We Offer</h1>
						<p class="all-p me-5 text-center">
						...
						<div class="col-lg-12">
							<ul class="AboutService-style">
								<li>
									...
									/>
									<a>
										<span class="fs-3">Blockchain</span>
										<br />
										Development Service
									</a>
								</li>
								...
								<li>
									...
									/>
									<a>
										<span class="fs-3">Cryptocurrency</span>
										<br />
										Development Service
									</a>
								</li>
								...
								<li>
									...
									/>
									<a>
										<span class="fs-3">Metaverse</span>
										<br />
										Development Service
									</a>
								</li>
								<li>
									...
									/>
									<a>
										<span class="fs-3">Mobile App</span>
										<br />
										Development Service
									</a>
								</li>
			...
			<div class="bg-color firstsec">
				<div class="container container-fluid  py-5">
					<section>
						<div class=" d-flex align-items-center flex-column justify-content-center mb-5">
							<h1 class="all-head">Our Customers</h1>
							<p class="all-p me-5 text-center">
			...
			<div class=" py-5">
				<div class="container container-fluid">
					<section>
						<div class=" d-flex align-items-center flex-column justify-content-center mb-5">
							<h1 class="all-head">Brands That Trust Our Work</h1>
						</div>
						<div class="row">
							<div class="col-lg-12">
			...
			<div class="container container-fluid mb-5 firstsec">
				<div class=" d-flex align-items-center flex-column justify-content-center mb-5">
					<h1 class="all-head">Our Global Presence </h1>
				...
				<div class="row">
					<div class="col-md-6 col-sm-12 pb-3 ">
						<div class="service-block p-4 h-100 ">
							<div class="d-flex justify-content-center customind mb-4">
								<img class="me-4" src="assets/images/india.png" />
								<h1>India</h1>
							</div>
