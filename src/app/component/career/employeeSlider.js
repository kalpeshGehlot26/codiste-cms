                    ...
                    employeeTestimonial?.map((testimonial, index) => {
                        return (
                            <SplideSlide className="splide__slide" key={index}>
                                <div className="d-flex career-block p-3 careerslide-height">
									<div className="col-auto flex-column d-flex align-items-center">
										<img
									...
									<div className="col mt-4  secondsec-p">
