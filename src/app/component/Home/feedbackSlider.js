    ...
    return (
        ...
        >
            <SplideTrack>
                <SplideSlide className="splide__slide">
                    <div className="p-3">
                        <div className="d-flex align-items-center justify-content-center">
                            <img className="my-4 client-logohome p-0 w-auto" alt="Ninza NFT" src="assets/images/client-logos/Danketsu-Logo-Blue (Ninja NFT).png" loading="lazy" />
                        </div>
                ...
                <SplideSlide className="splide__slide">
                    <div className="p-3">
                        <div className="d-flex align-items-center justify-content-center"><img className="my-4 client-logohome p-0 w-auto" alt="BonFire - Bonfire Real-Estate Fractionalized Marketplace" src="assets/images/client-logos/bonfire.png" loading="lazy" /></div>
                        <p className="secondsec-p">
                ...
                <SplideSlide className="splide__slide">
                    <div className="p-3">
                        <div className="d-flex align-items-center justify-content-center">
                            <img className="my-4 client-logohome p-0  w-auto" alt="Medizen - Pill Reminder and Drug interaction Detection app" src="assets/images/client-logos/Medizen.png" loading="lazy" />
                        </div>
                        <p className="secondsec-p">
