                        ...
                        <div class="row firstsec ">
                            <div class="col-12 col-md-8 col-lg-10 d-flex mx-auto flex-wrap my100 align-items-center justify-content-between">
                                <div class="col-12 col-lg-5 order-2 order-lg-1">
                                    <h1 class="all-head">Blockchain Development Company</h1>
                                    <p class="all-p me-5 my-4">Excel in blockchain space with reliable, secure, and robust
                                ...
                                <div class="col-12 col-lg-5 mb-5 mb-lg-0 order-1 order-lg-2"><img class='img-fluid' src="assets/images/main/Blockchain.png" alt="Blockchain" /></div>
                            </div>
                        </div>
                    </section>
                </div>
