					...
					<div className="col-lg-3 col-md-6 col-sm-12">
						<div className="footer-menu footer-top-mgr">
							...
							<ul className="footer-icon d-flex flex-wrap p-0 mt-4">
								...
								<li>
									<a href="https://in.linkedin.com/company/codiste-pvt-ltd/" target="_blank" aria-label="Visit Codiste Pvt Ltd LinkedIn Page">
								...
								<li>
									<a href="https://twitter.com/codistepvtltd" target="_blank" aria-label="Visit Codiste Pvt Ltd Twitter Profile">
										...
										<svg xmlns="http://www.w3.org/2000/svg" width="25" height="22" viewBox="0 0 49 48" fill="none">
											<path d="M28.0888 18.5133L44.8518 0H48.8911L29.8392 21.2062L48.8237 48H34.5516L22.1645 30.3619L6.34407 48H2.50676L20.5488 28.0729L0.82373 0H14.8939L28.0888 18.5133ZM43.3034 45.1725L13.2781 2.82749H6.34407L36.302 45.1725H43.3034Z" fill="#9598A6" />
										</svg>
									</a>
								</li>
								<li>
									<a href="https://www.youtube.com/@YourTechPartnerCodiste" target="_blank" aria-label="Visit Codiste Pvt Ltd YouTube Channel">
										<svg xmlns="http://www.w3.org/2000/svg" width="30" height="21" viewBox="0 0 30 21" fill="none">
											<path fillRule="evenodd" clipRule="evenodd" d="M4.37173 0.3891C2.0492 0.571566 0.29371 2.46013 0.18065 4.78707C0.0875001 6.7043 0 8.91053 0 10.4335C0 11.974 0.0895133 14.2134 0.18385 16.1457C0.296 18.4429 2.0113 20.3189 4.30147 20.5303C6.83663 20.7644 10.5047 21 15 21C19.4836 21 23.1443 20.7656 25.6787 20.5322C27.9778 20.3204 29.6965 18.4322 29.8071 16.1261C29.9047 14.0916 30 11.7637 30 10.4335C30 9.11767 29.9067 6.8253 29.8102 4.80653C29.6986 2.4706 27.9403 0.5703 25.6089 0.387567C23.1135 0.192 19.5142 0 15 0C10.4741 0 6.86787 0.193 4.37173 0.3891ZM12 5.981L19.7333 10.4335L12 14.8861V5.981Z" fill="#9598A6" />
										</svg>
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/codistepvtltd/" target="_blank" aria-label="Instagram icon">
								...
								<li>
									<a href="https://t.me/NishantBlockchain" target="_blank" aria-label="Visit Codiste Pvt Ltd Telegram Channel">
										<svg width="29" height="21" viewBox="0 0 29 21" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.375058 8.61863L27.4384 0.0261681C27.8448 -0.10334 28.2327 0.268885 28.1203 0.679875L23.3853 17.9921C23.3016 18.2978 22.9727 18.4652 22.6761 18.3529L13.1148 14.739C12.7389 14.5967 12.6458 14.1073 12.9438 13.8377L20.4444 7.04603C20.9054 6.62888 20.4078 5.89236 19.848 6.16459L7.29198 12.2673C7.15445 12.3343 6.99532 12.3391 6.85383 12.2814L0.334946 9.62871C-0.130972 9.43885 -0.104525 8.77061 0.375058 8.61863ZM15.4189 10.0824C15.6543 9.87803 15.3929 9.50977 15.1218 9.66395L9.13846 12.9294C8.59893 13.2364 8.34547 13.8769 8.52884 14.4698L10.3771 20.6884C10.471 21.0034 10.8668 21.1052 11.1009 20.8743L14.7899 17.3847C14.9406 17.2358 14.8926 16.9816 14.6977 16.8988L10.8699 14.9923C10.6596 14.8874 10.6182 14.606 10.7888 14.4452L15.4189 10.0824Z" fill="#9598A6" /></svg>
									</a>
								</li>
							</ul>
						</div>
